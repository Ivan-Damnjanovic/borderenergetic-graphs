...
total_parts = 200        # total number of parts (at least 200 for serious business :)

def run_be(part):
    print(f'Processing part {part}...')

    # has this part been already processed - maybe computer crashed in the meantime?
    graphs_file = f'be-part-{part}'
    results_file = f'be-part-{part}-results.csv'
    ...
    cmd = f'./geng -D4 {n} {part}/{total_parts} {graphs_file}'
    try:
